...
FINAL_MODEL_SAVE_PATH="$MODEL_SAVE_DIR/final_cvaemodel_${SLURM_JOB_ID}"
...
# Execute the script (REMOVED --dataset_root argument)
...
if [ $exit_code -eq 0 ]; then
  ...
  echo "Model saved to: ${FINAL_MODEL_SAVE_PATH}.pt"
else
